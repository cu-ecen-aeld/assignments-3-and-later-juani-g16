...
{
    const char *usernameHC = my_username();
    char *usernameFile = malloc_username_from_conf_file();

    /**
     * TODO: Replace the line below with your code here as described above to verify your /conf/username.txt 
     * config file and my_username() functions are setup properly
     */
    TEST_ASSERT_EQUAL_STRING_MESSAGE(usernameHC,usernameFile,"error, usernames are different");
}
